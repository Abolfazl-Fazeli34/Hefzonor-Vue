...
<!-- <div class="mb-4 mt-5 md:mt-10 border-b border-gray-200 dark:border-gray-700">
    <ul class="flex flex-wrap justify-center -mb-px text-sm font-medium text-center" id="default-styled-tab" data-tabs-toggle="#default-styled-tab-content" data-tabs-active-classes="text-purple-600 hover:text-purple-600 dark:text-purple-500 dark:hover:text-purple-500 border-purple-600 dark:border-purple-500" data-tabs-inactive-classes="dark:border-transparent text-gray-500 hover:text-gray-600 dark:text-gray-400 border-gray-100 hover:border-gray-300 dark:border-gray-700 dark:hover:text-gray-300" role="tablist">
        ...
        <li role="presentation">
            <button class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="dashboard-styled-tab" data-tabs-target="#styled-dashboard" type="button" role="tab" aria-controls="dashboard" aria-selected="false">آیه ای</button>
        </li>
    </ul>
</div>
...
<div id="default-styled-tab-content">
    <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="styled-profile" role="tabpanel" aria-labelledby="profile-tab">
        <div class="text-sm max-w-xl mx-auto text-gray-500 dark:text-gray-400 grid-cols-1">
          <div class="w-full flex items-center justify-between mb-8 mt-5">
            <button data-tooltip-target="tooltip-pause" type="button" class="inlinne-flex gap-2 items-center justify-center font-medium rounded-full hover:bg-blue-6700 group focus:outline-none hover:text-gray-400 dark:hover:text-gray-300">
            ...
            <button data-modal-target="crud-modal-setting" data-modal-toggle="crud-modal-setting" data-tooltip-target="tooltip-settings" type="button" class="p-2.5 group rounded-full hover:bg-gray-100  dark:hover:bg-gray-600">
          ...
          <div id="sidebar" class="fixed left-[22%] top-[25%] hidden -translate-x-1/2 md:flex flex-col gap-1.5 px-1.5 py-1.5 rounded-full shadow-xl border opacity-60 transition duration-300 z-30 bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700" >

            <button data-tooltip-target="tooltip-eye" type="button"
                    class="p-2 group rounded-full hover:bg-gray-100 dark:hover:bg-gray-600">
            ...
            <div id="tooltip-eye" role="tooltip" 
                class="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-xs opacity-0 tooltip dark:bg-gray-700">
              Hide
              <div class="tooltip-arrow" data-popper-arrow></div>
            </div>

            <button data-tooltip-target="tooltip-globe" type="button"
                    class="p-2 group rounded-full hover:bg-gray-100 dark:hover:bg-gray-600">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            ...
            <div id="tooltip-globe" role="tooltip" 
                class="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-xs opacity-0 tooltip dark:bg-gray-700">
              Globe
              <div class="tooltip-arrow" data-popper-arrow></div>
            </div>
            ...
            <button data-tooltip-target="tooltip-pencil" type="button"
                    class="p-2 group rounded-full hover:bg-gray-100 dark:hover:bg-gray-600">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            ...
            <div id="tooltip-pencil" role="tooltip" 
                class="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-xs opacity-0 tooltip dark:bg-gray-700">
              Edit
              <div class="tooltip-arrow" data-popper-arrow></div>
            </div>

            <button data-tooltip-target="tooltip-clipboard" type="button"
                    class="p-2 group rounded-full hover:bg-gray-100 dark:hover:bg-gray-600">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            ...
            <div id="tooltip-clipboard" role="tooltip" 
                class="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-xs opacity-0 tooltip dark:bg-gray-700">
              Clipboard
              <div class="tooltip-arrow" data-popper-arrow></div>
            </div>

            <button data-tooltip-target="tooltip-share" type="button"
                    class="p-2 group rounded-full hover:bg-gray-100 dark:hover:bg-gray-600">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
          ...
          <div  id="sidebar" class="fixed bottom-[94px] left-2 right-2 md:hidden md:left-[22%] md:top-[25%] md:-translate-x-1/2 flex flex-row md:flex-col px-1 py-1 md:px-1.5 md:py-1.5 rounded-full shadow-xl border opacity-60 transition duration-300 z-30 bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700 justify-around">
            <button data-tooltip-target="tooltip-eye" type="button"
                    class="p-1 group rounded-full hover:bg-gray-100 dark:hover:bg-gray-600">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                <path stroke-linecap="round" stroke-linejoin="round" d="M3.98 8.223A10.477 10.477 0 0 0 1.934 12C3.226 16.338 7.244 19.5 12 19.5c.993 0 1.953-.138 2.863-.395M6.228 6.228A10.451 10.451 0 0 1 12 4.5c4.756 0 8.773 3.162 10.065 7.498a10.522 10.522 0 0 1-4.293 5.774M6.228 6.228 3 3m3.228 3.228 3.65 3.65m7.894 7.894L21 21m-3.228-3.228-3.65-3.65m0 0a3 3 0 1 0-4.243-4.243m4.242 4.242L9.88 9.88" />
              </svg>
    ...
    <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="styled-dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
        <div class="text-sm max-w-xl mx-auto text-gray-500 dark:text-gray-400">
          This is some placeholder content the Clicking another tab will toggle the visibility of this one for the next. The tab JavaScript swaps classes to control the content visibility and styling.
        </div>
    </div>
</div> -->
...
<!-- Navbar Audio -->
<div class="fixed bottom-0 left-0 z-30 grid w-full h-20 grid-cols-1 px-8 bg-white border-t border-gray-200 md:grid-cols-3 dark:bg-gray-800 dark:border-gray-600">
    <div class="items-center justify-center hidden me-auto md:flex">
        ...
        <span class="text-sm md:text-xl/2 text-gray-500 dark:text-gray-400">قاری منشاوی</span>
    </div>
        ...
        <div class="w-full">
            <div class="flex items-center justify-between mb-1">
              ...
              <div class="flex items-center justify-center mx-auto">
                  ...
                  <button data-tooltip-target="tooltip-previous" type="button" class="p-2.5 group rounded-full hover:bg-gray-100  dark:hover:bg-gray-600">
                  ...
                  <button data-tooltip-target="tooltip-pause" type="button" class="inline-flex items-center justify-center p-2.5 mx-2 font-medium bg-blue-500 rounded-full hover:bg-blue-6700 group focus:ring-4 focus:ring-blue-300 focus:outline-none dark:focus:ring-blue-800">
                      <svg class="w-3 h-3 text-white">
                        <use href="#pause"></use>
                      </svg>
                  ...
                  <button data-tooltip-target="tooltip-next" type="button" class="p-2.5 group rounded-full hover:bg-gray-100 me-1  dark:hover:bg-gray-600">
                      <svg class="rtl:rotate-180 w-4 h-4 text-gray-500 dark:text-gray-300 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 12 16">
    ...
    <div class="items-center justify-center hidden ms-auto md:flex">
        ...
        <button data-tooltip-target="tooltip-volume" type="button" class="p-2.5 group rounded-full hover:bg-gray-100  dark:hover:bg-gray-600">
            <svg class="w-4 h-4 text-gray-500 dark:text-gray-300 group-hover:text-gray-900 dark:group-hover:text-white">
...
<!-- Modal Setting -->
<div id="crud-modal-setting" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-md max-h-full">
        <!-- Modal content -->
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
            <!-- Modal header -->
            <div class="flex items-center justify-between px-4 py-2 md:p-5 border-b rounded-t dark:border-gray-600 border-gray-200">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                    Create New Product
                </h3>
                <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="crud-modal-setting">
            ...
            <div class="mb-2 border-b border-gray-200 dark:border-gray-700 mt-2">
                <ul class="flex flex-wrap justify-center -mb-px text-sm font-medium text-center" id="default-tab" data-tabs-toggle="#default-tab-content" role="tablist">
                    <li class="me-2" role="presentation">
                        <button class="inline-block cursor-pointer px-2 py-1 border-b-2 rounded-t-lg" id="profile-tab" data-tabs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">Profile</button>
                    </li>
                    <li class="me-2" role="presentation">
                        <button class="inline-block cursor-pointer px-2 py-1 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="dashboard-tab" data-tabs-target="#dashboard" type="button" role="tab" aria-controls="dashboard" aria-selected="false">Dashboard</button>
                    </li>
                    <li class="me-2" role="presentation">
                        <button class="inline-block cursor-pointer px-2 py-1 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" id="settings-tab" data-tabs-target="#settings" type="button" role="tab" aria-controls="settings" aria-selected="false">Settings</button>
                    </li>
                </ul>
            </div>
            <div id="default-tab-content mx-3">
                ...
                <div class="hidden p-2 rounded-lg" id="settings" role="tabpanel" aria-labelledby="settings-tab">
                    <form class="p-2 md:p-3">
                        <div class="grid gap-4 mb-4 grid-cols-2">
                            <div class="col-span-2">
                                <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Name</label>
            ...
            <form class="p-4 md:p-5">
                <div class="grid gap-4 mb-4 grid-cols-2">
                    <div class="col-span-2">
                        ...
                        <select id="default" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
...
<!-- <div class="max-w-screen-lg mx-auto">
  <form class="flex items-center mx-auto  mb-14">   
      ...
      <div class="relative w-full flex items-center justify-stretch">
          ...
          <input type="text" id="voice-search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-r-lg focus:ring-blue-200 focus:border-blue-400 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search Mockups, Logos, Design Templates..." required />
          <button type="button" class="absolute inset-y-0 end-0 flex items-center pe-3">
...
const sidebarPosition = computed(() => {
  return windowWidth.value < 768
    ? "bottom-8 left-1/2 -translate-x-1/2 flex-row w-[95%] justify-center flex-wrap"
    : "left-1/4 top-1/3 -translate-x-1/2 flex-col";
});
